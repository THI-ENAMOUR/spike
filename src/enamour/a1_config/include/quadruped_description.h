...
namespace champ
{
    namespace URDF
    {
        ...
        {
      base.lf.hip.setOrigin(0.183, 0.047, 0.0, 0.0, 0.0, 0.0);
base.lf.upper_leg.setOrigin(0.0, 0.08505, -0.0, 0.0, 0.0, 0.0);
base.lf.lower_leg.setOrigin(0.0, 0.0, -0.2, 0.0, 0.0, 0.0);
     base.lf.foot.setOrigin(0.0, 0.0, -0.2, 0.0, 0.0, 0.0);

      base.rf.hip.setOrigin(0.183, -0.047, 0.0, 0.0, 0.0, 0.0);
base.rf.upper_leg.setOrigin(0.0, -0.08505, -0.0, 0.0, 0.0, 0.0);
base.rf.lower_leg.setOrigin(0.0, 0.0, -0.2, 0.0, 0.0, 0.0);
     base.rf.foot.setOrigin(0.0, 0.0, -0.2, 0.0, 0.0, 0.0);

      base.lh.hip.setOrigin(-0.183, 0.047, 0.0, 0.0, 0.0, 0.0);
base.lh.upper_leg.setOrigin(0.0, 0.08505, -0.0, 0.0, 0.0, 0.0);
base.lh.lower_leg.setOrigin(0.0, 0.0, -0.2, 0.0, 0.0, 0.0);
     base.lh.foot.setOrigin(0.0, 0.0, -0.2, 0.0, 0.0, 0.0);

      base.rh.hip.setOrigin(-0.183, -0.047, 0.0, 0.0, 0.0, 0.0);
base.rh.upper_leg.setOrigin(0.0, -0.08505, -0.0, 0.0, 0.0, 0.0);
